...
本目录用于 `baseline_v3` 训练配置。相对 `baseline_v1` 的关键变化：
...
python scripts/dl/formal/03_run_multiseed.py `
  --configs `
  configs/baseline_v3/train_vit_seg_baseline_v3_seed42.yaml `
  configs/baseline_v3/train_vit_seg_baseline_v3_seed3407.yaml `
  configs/baseline_v3/train_vit_seg_baseline_v3_seed2026.yaml
```
...
python scripts/dl/formal/04_aggregate_multiseed_results.py `
  ...
  configs/baseline_v3/train_vit_seg_baseline_v3_seed3407.yaml `
  configs/baseline_v3/train_vit_seg_baseline_v3_seed2026.yaml `
  --output-dir outputs/evaluation_reports/baseline_v3_multiseed
```
